...
$TEMP_DIR                            = 'C:/Temp/ubr_temp/';             // *ATTENTION * : The $TEMP_DIR value MUST be duplicated in the "ubr_upload.pl" file
...
$_INI['debug_ajax']                  = 1;                            // Enable/Disable AJAX debug mode. Add your own debug messages by calling the "showDebugMessage() " function. UPLOADS POSSIBLE.
