...
$_CONFIG['upload_dir']                            = $_SERVER['DOCUMENT_ROOT'] . '/Uber-Uploader/upload/ubr/';                                                                   // Path to upload directory
...
$_CONFIG['bucket_progress_bar']                   = 1;                                                                                                            // Enable the 'Bucket' style progress bar (Must disable Cedric style progress bar)
...
$_CONFIG['max_upload_size']                       = 6291456000;                                                                                                      // Maximum upload size (5 * 1024 * 1024 = 5242880 = 5MB)
$_CONFIG['overwrite_existing_files']              = 0;                                                                                                            // Overwrite any existing files by the same name in the upload folder
$_CONFIG['redirect_url']                          = 'http://'. $_SERVER['HTTP_HOST'] . '/Uber-Uploader/html/ubr_finished.php';                                                       // What page to load after the upload completes (only used if REDIRECT_METHOD ini setting is > 0)
...
$_CONFIG['allow_extensions']                      = '(zip|mp4|wma|wmv|mpg3|mpg|mpeg|avi|mov|jpg|jpeg|gif|bmp|png|tiff)';                                                  // Include file extentions that are allowed to be uploaded
